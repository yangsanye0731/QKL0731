...
for i in range(gegu_count):
    ...
    if "触发" in sign_result:
        common.dingding_markdown_msg_2('触发每日投资报告有鱼[火]，有鱼[火]！' + gegu.split('|')[2] + sign_result,
                                       '触发每日投资报告有鱼[火]，有鱼[火]！' + gegu.split('|')[2] + sign_result)
    rt1 = RichText('')
...
for i in range(gengong_count):
    ...
    if "触发" in sign_result:
        common.dingding_markdown_msg_2('触发每日投资报告有鱼[火]，有鱼[火]！' + genzong.split('|')[2] + sign_result,
                                       '触发每日投资报告有鱼[火]，有鱼[火]！' + genzong.split('|')[2] + sign_result)
