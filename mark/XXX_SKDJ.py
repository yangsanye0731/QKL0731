...
async def index(page, cookie1, url, codeName):
    try:
        ...
        print(num.array(k0)[-1])
        print(num.array(d0)[-1])
        k0Array = num.array(k0)
        d0Array = num.array(d0)
        if k0Array[-1] < 30 and k0Array[-2] < d0Array[-2] and k0Array[-1] > d0Array[-1]:
            print("================================================================================================" + codeName)
            time_str = time.strftime("%Y%m%d", time.localtime())
            fo = open("XXX_SKDJ_" + 'D' + "_" + time_str + ".txt", "a+")
            fo.write(codeName + "\n")
            fo.close()
