...
def strategy(zhouqi, endstr, database_id):
    ...
    time_str = endstr
    fo_60 = open("双均线60_120_" + zhouqi + "_" + time_str + ".txt", "w")
    ...
    for codeItem in all_code_index_x:
        try:
            ...
            ma120 = ta.SMA(doubleCloseArray, timeperiod=120)
            sma120 = ta.EMA(ma120, timeperiod=120)

            mark = ""
            if ma60[-1] > ma120[-1] and sma60[-1] > sma120[-1] and ma60[-1] > ma60[-2] and ma120[-1] > ma120[-2]:
                print("双均线10：" + codeItem)
                fo_60.write(codeItem + "\n")
                image_path, gai_nian = common_image.plt_image_tongyichutu_2(codeItem,
                                                                            "D",
                                                                            "【全部代码】双均线60,120",
                                                                            "【全部代码】双均线60,120", time_str, mark, 'multi')
