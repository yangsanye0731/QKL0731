...
#######################################################################################################################
###########################################################################################################跨域5周线策略
def strategy(zhouqi, endstr, all_code_index_x):
    # 局部变量初始化
    count = 0
    count_b = 0
    count_e = 0
...
##############################################################################################################主执行程序
a = num.array([])
df_qianyitian = pd.read_csv('./day_excel/china_2023-05-10_d4f35.csv')
df_houyitian = pd.read_csv('./day_excel/china_2023-05-11_0d015.csv')
# print(df1)
# print(df2)
for index in df_qianyitian.index:
    try:
        ...
        if df_qianyitian['商品代码'].get(index) == 300187:
...
# print(a)
# count_result_b, count_result_e = strategy('W', time_str1, a)
