...
def strategy(zhouqi, endstr):
    ...
    pro = ts.pro_api()
    all_code = pro.index_basic(market='SW')
    print(all_code)
    ...
    time_str = endstr
    fo_10 = open("双均线指数10_" + zhouqi + "_" + time_str + ".txt", "w")
    fo_60 = open("双均线指数60_" + zhouqi + "_" + time_str + ".txt", "w")
    fo_144 = open("双均线指数144_" + zhouqi + "_" + time_str + ".txt", "w")
    ...
    #         print(count)
            ...
            # df = pro.index_daily(ts_code=codeItem)
            # print(df)
