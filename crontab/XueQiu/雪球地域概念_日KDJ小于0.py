    ...
    try:
        ...
        if float(KDJ_J) < 0:
            image_path = common_image.plt_image_tongyichutu_zhishu_xueqiu(data_history['close'], codeItem, codeName,
                                                                          "D",
                                                                          "【雪球地域之无形的手】KDJ日线小于0",
                                                                          "【雪球地域之无形的手】KDJ日线小于0" + time_str,
                                                                          str(zhangdiefu[-1]),
                                                                          "%.2f" % huanshoulv[-1])
            image_url = "http://139.196.14.184/" + image_path[6:]
            print(image_url)
            common.dingding_markdown_msg_02('触发【雪球地域之无形的手】KDJ日线小于0' + time_str + codeName + '(' + codeItem + ')',
                                            '触发【雪球地域之无形的手】KDJ日线小于0' + time_str + codeName + '(' + codeItem + ')'
        ...
        if float(KDJ_J) > 80:
            image_path = common_image.plt_image_tongyichutu_zhishu_xueqiu(data_history['close'], codeItem, codeName,
                                                                          "D",
                                                                          "【雪球地域之无形的手】KDJ日线大于80",
                                                                          "【雪球地域之无形的手】KDJ日线大于80" + time_str,
                                                                          str(zhangdiefu[-1]),
                                                                          "%.2f" % huanshoulv[-1])
            image_url = "http://139.196.14.184/" + image_path[6:]
            print(image_url)
            common.dingding_markdown_msg_02('触发【雪球地域之无形的手】KDJ日线大于80' + time_str + codeName + '(' + codeItem + ')',
                                            '触发【雪球地域之无形的手】KDJ日线大于80' + time_str + codeName + '(' + codeItem + ')'
                                            + "\n\n> ![screenshot](" + image_url + ")")
