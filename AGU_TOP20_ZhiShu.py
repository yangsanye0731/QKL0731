...
def execute():
    ...
    jsonDicCode1 = [('399001', '深证成指'), ('399006', '创业板指'),('399231', '农林指数'), ('399232', '采矿指数'),
                    ...
                    ('399368', '国证军工'), ('399382', '1000材料'), ('399394', '国证医药'), ('399395', '国证有色'), ('399396', '国证食品'),
                    ('399412', '国证新能'), ('399432', '国证汽车与汽车零配件行业'), ('399437', '国证证券'), ('399431', '国证银行'),
                    ('399434', '国证传媒'), ('399435', '国证农林牧渔'), ('399441', '国证生物医药'), ('399693', '安防产业'),
                    ('399804', '中证体育产业'), ('399807', '中证高铁产业'), ('399812', '中证养老产业'),
                    ('399936', '中证电信指数'), ('399936', '中证信息技术'), ('399970', '中证移动互联网'), ('399976', '中证新能源汽车'),
