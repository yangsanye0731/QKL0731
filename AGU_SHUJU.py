...
def strategy(type):
    ...
    if flag:
        ...
        send_image(code='300322', name='【跨越5月线】硕贝德', only_qushi_image=True)
        send_image(code='603363', name='【跨越5周线，主力持仓增长】傲农生物', only_qushi_image=True)
        send_image(code='002768', name='【低市盈率，广州强】国恩股份', only_qushi_image=True)
